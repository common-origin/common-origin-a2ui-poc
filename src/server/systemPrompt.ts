...
Response (JSONL):
{"surfaceUpdate":{"surfaceId":"main","components":[{"id":"root","component":{"Stack":{"direction":"column","gap":"lg"}},"children":["header","accounts"]},{"id":"header","component":{"Text":{"text":{"literalString":"Your accounts"},"variant":"h1"}}},{"id":"accounts","component":{"Stack":{"direction":"column","gap":"md"}},"children":["acc1","acc2","acc3"]},{"id":"acc1","component":{"AccountCard":{"accountType":"checking","accountName":{"literalString":"Everyday Transaction"},"balance":5280.50,"accountNumber":"1234","trend":"up","trendValue":{"literalString":"+2.5%"},"currency":"AUD"}}},{"id":"acc2","component":{"AccountCard":{"accountType":"savings","accountName":{"literalString":"High Interest Savings"},"balance":12450.00,"accountNumber":"5678","trend":"up","trendValue":{"literalString":"+3.2%"},"currency":"AUD"}}},{"id":"acc3","component":{"AccountCard":{"accountType":"credit","accountName":{"literalString":"Platinum Credit Card"},"balance":-876.32,"accountNumber":"9012","currency":"AUD"}}}]}}
{"beginRendering":{"surfaceId":"main","root":"root","catalogId":"common-origin.design-system:v2.3"}}
...
7. **Provide realistic data**: Generate reasonable mock data for Australian banking (AUD currency, Australian retailers)
