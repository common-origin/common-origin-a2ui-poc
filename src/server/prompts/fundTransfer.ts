...
{"id":"x","component":"Button","label":"Label","variant":"primary"|"secondary"|"naked","action":{"name":"action_name","context":[{"key":"field","value":{"path":"/field"}}]}}

## AccountCard — Account display
{"id":"x","component":"AccountCard","accountName":"Name","accountNumber":"1234","balance":5000.00,"currency":"AUD","accountType":"everyday"|"savings"}
